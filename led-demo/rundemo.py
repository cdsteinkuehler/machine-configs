...
parser = argparse.ArgumentParser(description='This is the LED-demo run script '
                                 'it demonstrates how a run script could look like '
                                 'and of course starts the LED-demo')
...
#    launcher.load_hal_file('hardware.hal',  'led-demo.ini')
    ...
    if args.gladevcp:
        ...
        if args.local:
            ...
            launcher.start_process('gladevcp -E -u led-demo.py led-demo.ui')
        else:
            # -N - remote case, use zeroconf resolution
            launcher.start_process('gladevcp -N -E -u led-demo.py led-demo.ui')
    if args.halscope:
